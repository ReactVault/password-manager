...
describe('Unit testing React components',  () => {
  ...
  describe('Navbar', () => {
    test('click on Landing Page should redirect to LandingPage', async () => {
      ...
      expect(screen.getByRole('heading', { name: 'Welcome to Password Manager' })).toBeInTheDocument()
    })
    ...
    test('click on Search should redirect to Search page', async () => {
      ...
      expect(screen.getByRole('heading', { name: 'You\'re in!', level: 1 })).toBeInTheDocument()
    })
  });
